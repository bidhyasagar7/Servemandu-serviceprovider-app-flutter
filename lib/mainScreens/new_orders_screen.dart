...
import 'package:servemandu_sp_app/assistantMethods/assistant_methods.dart';
import 'package:servemandu_sp_app/global/global.dart';
import 'package:servemandu_sp_app/widgets/order_card.dart';
import 'package:servemandu_sp_app/widgets/progress_bar.dart';
import 'package:servemandu_sp_app/widgets/simple-app-bar.dart';
                      ...
                      return FutureBuilder<QuerySnapshot>(
                        ...
                        builder: (c, snap)
                        {
                          return snap.hasData
                            ...
                            //seperateQuantitiesList: separateOrderItemQuantities((snapshot.data!.docs[index].data()! as Map<String, dynamic>)["serviceIDs"]),
                          )
