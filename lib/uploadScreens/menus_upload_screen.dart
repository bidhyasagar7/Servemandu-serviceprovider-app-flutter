// ignore_for_file: library_prefixes, library_private_types_in_public_api, sort_child_properties_last, sized_box_for_whitespace, prefer_interpolation_to_compose_strings
...
import 'package:servemandu_sp_app/widgets/error_dialog.dart';
...
class _MenusUploadScreenState extends State<MenusUploadScreen>
{
  ...
  takeImage(mContext)
  {
    return showDialog(
      ...
      {
        return SimpleDialog(
          title: const Text("Service Image", style: TextStyle(color: Colors.amber, fontWeight: FontWeight.bold),),
          children: [
            SimpleDialogOption(
              child: const Text(
                "Capture with Camera",
